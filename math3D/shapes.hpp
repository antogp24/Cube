...
namespace shapes
{
    ...
    void connect(int indexStt, int indexEnd, std::vector<Vector>& points, sf::RenderWindow& window, Window& win)
    {
        line(points[indexStt].x + win.center.x, points[indexStt].y + win.center.y,
